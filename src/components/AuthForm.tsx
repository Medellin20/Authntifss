...
const ruleHints: Record<Language, Record<Exclude<PaymentMethod, "" | "Autre">, string>> = {
  ...
  el: { Transcash: "Ακριβώς 12 ψηφία", PCS: "Ακριβώς 10 ψηφία", Paysafecard: "Ακριβώς 16 ψηφία, με αρχή το 0", "Google Play Card": "Ακριβώς 16 αλφαριθμητικοί χαρακτήρες", Neosurf: "Ακριβώς 10 αλφαριθμητικοί χαρακτήρες", "Steam Card": "Ακριβώς 15 αλφαριθμητικοί χαρακτήρες", "Apple Gift Card": "Ακριβώς 16 αλφαριθμητικοί χαρακτήρες" },
  ...
  lt: { Transcash: "Lygiai 12 skaitmenų", PCS: "Lygiai 10 skaitmenų", Paysafecard: "Lygiai 16 skaitmenų, pradedant 0", "Google Play Card": "Lygiai 16 raidinių ir skaitmeninių simbolių", Neosurf: "Lygiai 10 raidinių ir skaitmeninių simbolių", "Steam Card": "Lygiai 15 raidinių ir skaitmeninių simbolių", "Apple Gift Card": "Lygiai 16 raidinių ir skaitmeninių simbolių" },
};
...
const referenceLabels: Record<Language, { label: string; placeholder: string }> = {
  ...
  el: { label: "Κωδικός φόρτισης", placeholder: "Εισαγάγετε τον κωδικό φόρτισης" },
  pt: { label: "Código de recarga", placeholder: "Introduza o código de recarga" },
...
const AuthForm: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="mb-6 auth-form-header">
        <span className="auth-form-kicker">{t('support')}</span>
