...
const fr = {
  ...
  fullName: "Nom et prénom", fullNamePlaceholder: "Votre pseudo ou nom complet", email: "Adresse e-mail", payment: "Moyen de paiement concerné", select: "Sélectionnez une option", other: "Autre", amount: "Montant concerné", amountPlaceholder: "Exemple : 50", reference: "Saisissez les 12 caractères de la référence", referencePlaceholder: "Exemple : 254785496584", showRechargeCodes: "Afficher les codes de recharge", consent: "J’accepte que mes informations soient utilisées pour traiter ma demande.", sending: "Envoi en cours…", send: "Envoyer ma demande", success: "Votre demande a bien été envoyée.", error: "Votre demande n’a pas pu être envoyée. Veuillez réessayer.", bot: "Ne remplissez pas ce champ :",
